...
})({"a1GsQ":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "3e698857525c635f";
"use strict";
...
function initializeSwipers() {
    ...
    contentSwiper = new Swiper(".swiper.is-content", {
        ...
        on: {
            ...
            init: function(swiper) {
                if (window.innerWidth > TABLET_BREAKPOINT) swiper.slides.forEach((slide)=>slide.style.opacity = 0);
    ...
    photoSwiper = new Swiper(".swiper.is-photos", {
        ...
        on: {
            init () {
                ...
                if (window.innerWidth > MOBILE_BREAKPOINT) arrowClickHandler();
            },
            ...
            slideChange (swiper) {
                ...
                if (fadeElement) {
                    fadeElement.style.transition = "opacity 0.5s cubic-bezier(0.65, 0, 0.35, 1)";
            ...
            slideChangeTransitionStart: function() {
                setTimeout(()=>{
                    document.querySelectorAll(".swiper-slide.is-photos:not(.swiper-slide-active) .testimonial_border-img").forEach((element)=>{
    ...
    if (window.innerWidth > TABLET_BREAKPOINT) document.querySelectorAll(".swiper-wrapper").forEach((wrapper)=>{
    ...
    window.addEventListener("resize", ()=>{
        document.querySelectorAll(".swiper-wrapper").forEach((wrapper)=>{
            if (window.innerWidth <= TABLET_BREAKPOINT) wrapper.style.transitionTimingFunction = "";
...
window.addEventListener("resize", ()=>{
    ...
    const crossedMobileBreakpoint = lastWidth <= MOBILE_BREAKPOINT && currentWidth > MOBILE_BREAKPOINT || lastWidth > MOBILE_BREAKPOINT && currentWidth <= MOBILE_BREAKPOINT;
    const crossedTabletBreakpoint = lastWidth <= TABLET_BREAKPOINT && currentWidth > TABLET_BREAKPOINT || lastWidth > TABLET_BREAKPOINT && currentWidth <= TABLET_BREAKPOINT;
    if (crossedMobileBreakpoint || crossedTabletBreakpoint) initializeSwipers();
